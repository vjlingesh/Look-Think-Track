...
while(True):
	...
	if (resA == 0.0):
		...
		cv2.putText(img,'No Shelf',(box1[0][0],box1[0][1]+100), font, 1,(255,255,255),2)
	elif (resA == 2.0):
	...
	if (resB == 0.0):
		...
		cv2.putText(img,'No Shelf',(box2[0][0],box2[0][1]+100), font, 1,(255,255,255),2)
	elif (resB == 2.0):
	...
	if (resC == 0.0):
		...
		cv2.putText(img,'No Shelf',(box3[0][0],box3[0][1]+100), font, 1,(255,255,255),2)
	elif (resC == 2.0):
	...
	if (resD == 0.0):
		...
		cv2.putText(img,'No Shelf',(box4[0][0],box4[0][1]+100), font, 1,(255,255,255),2)
	elif (resD == 2.0):
	...
	if (resE == 0.0):
		...
		cv2.putText(img,'No Shelf',(box5[0][0],box5[0][1]+100), font, 1,(255,255,255),2)
	elif (resE == 2.0):
	...
	if (resF == 0.0):
		...
		cv2.putText(img,'No Shelf',(box6[0][0],box6[0][1]+100), font, 1,(255,255,255),2)
	elif (resF == 2.0):
